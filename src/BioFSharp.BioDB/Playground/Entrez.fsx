...
#r "nuget: Hopac"
#r "nuget: BioFSharp.BioDB, 0.0.1-beta" // this is coming from the packages folder via the Nuget.Config file, run the pack build task once to make it work

#I @"C:\Users\Kevin\.nuget\packages\hopac\0.5.0\lib\netstandard2.0"
